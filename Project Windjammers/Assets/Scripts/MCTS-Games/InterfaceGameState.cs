...
public class InterfaceGameState : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        j1 = new Joueur(gameManager.j1.position, Vector2.zero, j1.moveSpeed, j1.PlayerTag,this.gameManager.CenterPoint[0].position,new Vector2(gameManager.WidthPlayer/2f,gameManager.HeightPlayer),new Score(0,0));
        j2 = new Joueur(gameManager.j2.position, Vector2.zero, j2.moveSpeed,j2.PlayerTag,this.gameManager.CenterPoint[1].position,new Vector2(gameManager.WidthPlayer/2f,gameManager.HeightPlayer),new Score(0,0));
